...
const Footer = () => {
  return (
    <div className="bg-darkRed text-white">
        ...
        <div className=" grid md:grid-cols-4 py-5">
          ...
          <div className=" py-8 px-4 ">
            ...
            <div className="flex items-center gap-3 mt-6">
              <a target="_blank" href="https://www.instagram.com/0to60_motoring/ " rel="noopener noreferrer">
                <FaInstagram className="text-xl md:text-3xl hover:text-primary duration-300" />
              </a>
              <a target="_blank" href="https://www.facebook.com/0to60Motoring" rel="noopener noreferrer">
                <FaFacebook className="text-xl md:text-3xl hover:text-primary duration-300" />
              </a>
              <a target="_blank" href="https://www.tiktok.com/@0to60motoring?is_from_webapp=1&sender_device=pc" rel="noopener noreferrer">
                <FaTiktok className="text-xl md:text-3xl hover:text-primary duration-300" />
              </a>
              <a target="_blank" href="https://twitter.com/0Motoring " rel="noopener noreferrer">
      ...
      <div className="mt-4 flex items-center justify-center gap-2 mb-1">
            <p><AiFillCopyrightCircle /></p><p>{new Date().getFullYear()}</p><Link href="www.0-60motoring.com">
              www.0-60motoring.com</Link>
            </div>
    </div>
  );
};
